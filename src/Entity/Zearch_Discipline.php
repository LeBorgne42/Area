...
/**
 * @ORM\Table(name="z_discipline")
 * @ORM\Entity
 */
class Zearch_Discipline
{
    /**
    ...
    /**
     * @ORM\OneToOne(targetEntity="Research", mappedBy="discipline", fetch="EXTRA_LAZY")
     */
    protected $research;
