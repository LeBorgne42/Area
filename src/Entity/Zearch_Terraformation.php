...
/**
 * @ORM\Table(name="z_terraformation")
 * @ORM\Entity
 */
class Zearch_Terraformation
{
    /**
    ...
    /**
     * @ORM\OneToOne(targetEntity="Research", mappedBy="terraformation", fetch="EXTRA_LAZY")
     */
    protected $research;
