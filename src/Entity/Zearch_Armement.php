...
/**
 * @ORM\Table(name="z_armement")
 * @ORM\Entity
 */
class Zearch_Armement
{
    /**
    ...
    /**
     * @ORM\OneToOne(targetEntity="Research", mappedBy="armement", fetch="EXTRA_LAZY")
     */
    protected $research;
