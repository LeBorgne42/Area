...
/**
 * @ORM\Table(name="z_demography")
 * @ORM\Entity
 */
class Zearch_Demography
{
    /**
    ...
    /**
     * @ORM\OneToOne(targetEntity="Research", mappedBy="demography", fetch="EXTRA_LAZY")
     */
    protected $research;
