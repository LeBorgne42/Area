...
/**
 * @ORM\Table(name="x_caserne")
 * @ORM\Entity
 */
class Xuilding_Caserne
{
    /**
    ...
    /**
     * @ORM\OneToOne(targetEntity="Building", mappedBy="caserne", fetch="EXTRA_LAZY")
     */
    protected $building;
