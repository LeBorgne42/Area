...
/**
 * @ORM\Table(name="y_recycleur")
 * @ORM\Entity
 */
class Yhip_Recycleur
{
    /**
    ...
    /**
     * @ORM\OneToOne(targetEntity="Ship", mappedBy="recycleur", fetch="EXTRA_LAZY")
     */
    protected $ship;
