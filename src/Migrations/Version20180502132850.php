 ...
 */
class Version20180502132850 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE u_message (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, sender INT NOT NULL, title VARCHAR(20) NOT NULL, content VARCHAR(500) NOT NULL, bitcoin BIGINT NOT NULL, sendAt DATETIME NOT NULL, INDEX IDX_FBEA9C5FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
