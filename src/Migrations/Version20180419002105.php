 ...
 */
class Version20180419002105 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE building (id INT AUTO_INCREMENT NOT NULL, planet_id INT DEFAULT NULL, miner_id INT DEFAULT NULL, extractor_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_E16F61D4A25E9820 (planet_id), UNIQUE INDEX UNIQ_E16F61D4BF88117 (miner_id), UNIQUE INDEX UNIQ_E16F61D4DBCA8D53 (extractor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE worker (id INT AUTO_INCREMENT NOT NULL, planet_id INT DEFAULT NULL, fleet_id INT DEFAULT NULL, amount NUMERIC(28, 5) NOT NULL, life INT NOT NULL, UNIQUE INDEX UNIQ_9FB2BF62A25E9820 (planet_id), UNIQUE INDEX UNIQ_9FB2BF624B061DF9 (fleet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE x_miner (id INT AUTO_INCREMENT NOT NULL, niobium INT NOT NULL, water INT NOT NULL, production NUMERIC(9, 5) NOT NULL, level INT NOT NULL, finishAt DATETIME DEFAULT NULL, constructTime INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
