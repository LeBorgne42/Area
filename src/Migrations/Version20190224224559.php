 ...
 */
final class Version20190224224559 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_quest ADD CONSTRAINT FK_A1D5034FA76ED395 FOREIGN KEY (user_id) REFERENCES app_users (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE quest_user (quest_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_83997ABB209E9EF4 (quest_id), INDEX IDX_83997ABBA76ED395 (user_id), PRIMARY KEY(quest_id, user_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
