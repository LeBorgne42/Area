...
class Version20180421213120 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE ship (id INT AUTO_INCREMENT NOT NULL, fleet_id INT DEFAULT NULL, orbite_id INT DEFAULT NULL, planet_id INT DEFAULT NULL, sonde_id INT DEFAULT NULL, colonizer_id INT DEFAULT NULL, hunter_id INT DEFAULT NULL, fregate_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_FA30EB244B061DF9 (fleet_id), UNIQUE INDEX UNIQ_FA30EB2421DE9274 (orbite_id), UNIQUE INDEX UNIQ_FA30EB24A25E9820 (planet_id), UNIQUE INDEX UNIQ_FA30EB24F1B7D1A2 (sonde_id), UNIQUE INDEX UNIQ_FA30EB24D726A9F2 (colonizer_id), UNIQUE INDEX UNIQ_FA30EB24A7DC5C81 (hunter_id), UNIQUE INDEX UNIQ_FA30EB246D3EAA45 (fregate_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE research (id INT AUTO_INCREMENT NOT NULL, onde_id INT DEFAULT NULL, industry_id INT DEFAULT NULL, discipline_id INT DEFAULT NULL, hyperespace_id INT DEFAULT NULL, utility_id INT DEFAULT NULL, demography_id INT DEFAULT NULL, terraformation_id INT DEFAULT NULL, cargo_id INT DEFAULT NULL, recycleur_id INT DEFAULT NULL, armement_id INT DEFAULT NULL, missile_id INT DEFAULT NULL, laser_id INT DEFAULT NULL, plasma_id INT DEFAULT NULL, lightShip_id INT DEFAULT NULL, heavyShip_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_57EB50C22B2647C6 (onde_id), UNIQUE INDEX UNIQ_57EB50C22B19A734 (industry_id), UNIQUE INDEX UNIQ_57EB50C211093B1B (lightShip_id), UNIQUE INDEX UNIQ_57EB50C2EA0C6ED6 (heavyShip_id), UNIQUE INDEX UNIQ_57EB50C2A5522701 (discipline_id), UNIQUE INDEX UNIQ_57EB50C2F4AA385D (hyperespace_id), UNIQUE INDEX UNIQ_57EB50C27189C2DB (utility_id), UNIQUE INDEX UNIQ_57EB50C21C829638 (demography_id), UNIQUE INDEX UNIQ_57EB50C2C220B9DF (terraformation_id), UNIQUE INDEX UNIQ_57EB50C2813AC380 (cargo_id), UNIQUE INDEX UNIQ_57EB50C2D7B82D29 (recycleur_id), UNIQUE INDEX UNIQ_57EB50C2D4413494 (armement_id), UNIQUE INDEX UNIQ_57EB50C22ECD5341 (missile_id), UNIQUE INDEX UNIQ_57EB50C24BF5DEAB (laser_id), UNIQUE INDEX UNIQ_57EB50C24AA16509 (plasma_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
