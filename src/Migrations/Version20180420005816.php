 ...
 */
class Version20180420005816 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE z_terraformation (id INT AUTO_INCREMENT NOT NULL, bitcoin INT NOT NULL, level TINYINT(1) NOT NULL, finishAt DATETIME DEFAULT NULL, constructTime BIGINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE research (id INT AUTO_INCREMENT NOT NULL, onde_id INT DEFAULT NULL, industry_id INT DEFAULT NULL, discipline_id INT DEFAULT NULL, hyperespace_id INT DEFAULT NULL, utility_id INT DEFAULT NULL, demography_id INT DEFAULT NULL, terraformation_id INT DEFAULT NULL, lightShip_id INT DEFAULT NULL, heavyShip_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_57EB50C22B2647C6 (onde_id), UNIQUE INDEX UNIQ_57EB50C22B19A734 (industry_id), UNIQUE INDEX UNIQ_57EB50C211093B1B (lightShip_id), UNIQUE INDEX UNIQ_57EB50C2EA0C6ED6 (heavyShip_id), UNIQUE INDEX UNIQ_57EB50C2A5522701 (discipline_id), UNIQUE INDEX UNIQ_57EB50C2F4AA385D (hyperespace_id), UNIQUE INDEX UNIQ_57EB50C27189C2DB (utility_id), UNIQUE INDEX UNIQ_57EB50C21C829638 (demography_id), UNIQUE INDEX UNIQ_57EB50C2C220B9DF (terraformation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE z_hyperespace (id INT AUTO_INCREMENT NOT NULL, bitcoin INT NOT NULL, level TINYINT(1) NOT NULL, finishAt DATETIME DEFAULT NULL, constructTime BIGINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
