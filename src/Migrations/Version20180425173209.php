...
class Version20180425173209 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE fleet (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, planet_id INT DEFAULT NULL, name VARCHAR(15) NOT NULL, attack TINYINT(1) NOT NULL, oldPlanet INT DEFAULT NULL, flightTime DATETIME DEFAULT NULL, sonde BIGINT DEFAULT NULL, colonizer INT DEFAULT NULL, recycleur INT DEFAULT NULL, barge INT DEFAULT NULL, hunter BIGINT DEFAULT NULL, fregate BIGINT DEFAULT NULL, soldier INT DEFAULT NULL, worker INT DEFAULT NULL, scientist INT DEFAULT NULL, INDEX IDX_A05E1E47A76ED395 (user_id), INDEX IDX_A05E1E47A25E9820 (planet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
