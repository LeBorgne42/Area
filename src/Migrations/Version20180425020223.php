 ...
 */
class Version20180425020223 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE fleet (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, planet_id INT DEFAULT NULL, ship_id INT DEFAULT NULL, name VARCHAR(15) NOT NULL, oldPlanet INT DEFAULT NULL, flightTime DATETIME DEFAULT NULL, soldier INT DEFAULT NULL, worker INT DEFAULT NULL, scientist INT DEFAULT NULL, INDEX IDX_A05E1E47A76ED395 (user_id), INDEX IDX_A05E1E47A25E9820 (planet_id), UNIQUE INDEX UNIQ_A05E1E47C256317D (ship_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE planet (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, building_id INT DEFAULT NULL, ship_id INT DEFAULT NULL, sector_id INT DEFAULT NULL, name VARCHAR(15) DEFAULT NULL, niobium NUMERIC(28, 5) NOT NULL, water NUMERIC(28, 5) NOT NULL, soldier INT DEFAULT NULL, worker INT NOT NULL, scientist INT DEFAULT NULL, position INT NOT NULL, ground INT DEFAULT NULL, groundPlace INT DEFAULT NULL, sky INT DEFAULT NULL, skyPlace INT DEFAULT NULL, empty TINYINT(1) NOT NULL, cdr TINYINT(1) NOT NULL, merchant TINYINT(1) NOT NULL, imageName VARCHAR(20) DEFAULT NULL, INDEX IDX_68136AA5A76ED395 (user_id), UNIQUE INDEX UNIQ_68136AA54D2A7E12 (building_id), UNIQUE INDEX UNIQ_68136AA5C256317D (ship_id), INDEX IDX_68136AA5DE95C867 (sector_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
