 ...
 */
class Version20180419024606 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE building (id INT AUTO_INCREMENT NOT NULL, miner_id INT DEFAULT NULL, extractor_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_E16F61D4BF88117 (miner_id), UNIQUE INDEX UNIQ_E16F61D4DBCA8D53 (extractor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
